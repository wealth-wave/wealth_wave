...
class SipService {
  ...
  Future<void> _performSipTransaction(Sip sip) {
    return Future.wait(sip.getFuturePayment(till: DateTime.now()).map(
        (payment) => _transactionApi.create(
