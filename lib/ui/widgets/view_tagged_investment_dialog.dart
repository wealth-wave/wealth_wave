...
import 'package:wealth_wave/ui/presentation/tagged_investment_presenter.dart';
      ...
      content: SizedBox(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return ListTile(
                title: Text(
                    '${formatToCurrency(taggedInvestment.currentValue)}(${formatToPercentage(taggedInvestment.split)}) of ${taggedInvestment.investmentName}'),
